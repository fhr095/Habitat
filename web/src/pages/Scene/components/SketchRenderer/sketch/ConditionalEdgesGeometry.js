...
export class ConditionalEdgesGeometry extends THREE.BufferGeometry {
  constructor(geometry) {
    ...
    this.setAttribute('position', new THREE.BufferAttribute(new Float32Array(edgePositions), 3, false));
    this.setAttribute('direction', new THREE.BufferAttribute(new Float32Array(edgeDirections), 3, false));
    this.setAttribute('control0', new THREE.BufferAttribute(new Float32Array(edgeControl0), 3, false));
    this.setAttribute('control1', new THREE.BufferAttribute(new Float32Array(edgeControl1), 3, false));
  }
}