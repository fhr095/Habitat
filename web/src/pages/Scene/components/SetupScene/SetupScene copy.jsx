...
const setupCamera = () => {
  ...
  const setupWater = (scene) => {
    ...
    const setupSkybox = (scene) => {
      if (skyboxEnabled && skyboxTexturePath) {
        const loader = new THREE.CubeTextureLoader();
        const texture = loader.load([
          `${skyboxTexturePath}/surround/1.jpg`,
          `${skyboxTexturePath}/surround/2.jpg`,
          `${skyboxTexturePath}/surround/3.jpg`,
          `${skyboxTexturePath}/surround/4.jpg`,
          `${skyboxTexturePath}/surround/5.jpg`,
          `${skyboxTexturePath}/surround/6.jpg`,
        ]);
    ...
    const setupEnvironmentMap = (scene) => {
      if (skyboxEnvironmentMapEnabled && skyboxTexturePath) {
        console.log("Iniciando EnvironmentMap: ");
        const loader = new THREE.CubeTextureLoader();
        const texture = loader.load([
          `${skyboxTexturePath}/surround/1.jpg`,
          `${skyboxTexturePath}/surround/2.jpg`,
