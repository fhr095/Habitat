...
import { useVisualizationMode } from "../../../../context/VisualizationModeContext"; // Importação adicionada
import { objectMapper } from "../../utils/ObjectReferenceMapper"; // Importação adicionada
...
export default function Response({
  ...
  const { currentMode } = useVisualizationMode(); // Acesso ao contexto de modo visual
  ...
  // Versão atualizada de playAudioSequentially para trabalhar com ambos os modos
